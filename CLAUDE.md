...
## Project Overview
An MCP (Model Context Protocol) server providing 118+ Formula 1 analytics tools powered by FastF1 and Ergast APIs. Runs via FastMCP with SSE transport on port 8000.
